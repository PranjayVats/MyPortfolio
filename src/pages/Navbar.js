...
const Navbar = () => {
  return <div className="w-full h-[4rem]"> <nav className="flex sticky bg-white z-40 top-0 px-5 h-auto w-screen items-center justify-between py-2 border-b border-gray-300 ">
  <div className="flex items-center justify-start w-4/5">
    <figure className="flex flex-wrap justify-between items-center text-[#5F6368] text-xl font-google mr-10">
      <img src={Classroom} className="w-10 mr-2" alt="drive-Logo" />
